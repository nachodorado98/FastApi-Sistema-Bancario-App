...
def test_obtener_transferencias_realizadas_no_existen(conexion):

	assert conexion.obtenerTransferenciasRealizadas("nacho98") is None
...
def test_obtener_transferencias_realizadas_existen(conexion, usuario1, usuario2):
	...
	transferencias=conexion.obtenerTransferenciasRealizadas(usuario1)

	assert len(transferencias)==2

def test_obtener_transferencias_recibidas_no_existen(conexion):

	assert conexion.obtenerTransferenciasRecibidas("nacho98") is None
...
def test_obtener_transferencias_recibidas_existen(conexion, usuario1, usuario2):
	...
	transferencias=conexion.obtenerTransferenciasRecibidas(usuario1)
